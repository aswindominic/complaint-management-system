...
<head>
  <meta charset="UTF-8">
  <title>Washing Machine Complaint Form</title>
  <link rel="stylesheet" href="washingmachine-style.css">
</head>
<body>
  <div class="container">
    <h2>Washing Machine Complaint Registration</h2>

    <!-- Technician Availability -->
    <p style="text-align: center; color: green; font-weight: bold;">
      🛠 Available Technicians for Washing Machine: <?php echo htmlspecialchars($availableTechs); ?>
    </p>
<form class="complaint-form" id="complaintForm" action="submit_complaint.php" method="POST" enctype="multipart/form-data">
  <input type="hidden" name="device_type" value="Washing Machine" />
  ...
  <div class="input-group">
    ...
    <select id="preset" name="complaint_type">
      ...
      <option value="Water not draining">Water not draining</option>
      <option value="Making unusual noise">Making unusual noise</option>
      <option value="Door not locking/unlocking">Door not locking/unlocking</option>
      <option value="Water leakage">Water leakage</option>
      <option value="Buttons or display not working">Buttons or display not working</option>
      <option value="Drum not rotating">Drum not rotating</option>
