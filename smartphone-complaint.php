...
if (!$conn->connect_error) {
    $deviceType = 'Smartphone'; // Or dynamically from hidden input if you want
...
<head>
  <meta charset="UTF-8">
  <title>Smartphone Complaint Form</title>
  <link rel="stylesheet" href="smartphone-style.css">
</head>
<body>
  <div class="container">
    <h2>Smartphone Complaint Registration</h2>

    <!-- Technician Availability -->
    <p style="text-align: center; color: green; font-weight: bold;">
      👷 Available Technicians for Smartphone: <?php echo htmlspecialchars($availableTechs); ?>
    </p>
    ...
    <form class="complaint-form" id="complaintForm" action="submit_complaint.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="input-group">
        ...
        <select id="preset" name="complaint_type">
          ...
          <option value="Battery drains quickly">Battery drains quickly</option>
          <option value="Phone not charging">Phone not charging</option>
          <option value="Screen not working">Screen not working</option>
          <option value="Speaker or mic issue">Speaker or mic issue</option>
          <option value="Overheating">Overheating</option>
          <option value="Camera not working">Camera not working</option>
          <option value="Hanging or freezing">Hanging or freezing</option>
