...
if (!$conn->connect_error) {
    $deviceType = 'Laptop'; // Or use $_POST['device_type'] if you want it dynamic
...
<head>
  <meta charset="UTF-8">
  <title>Laptop Complaint Form</title>
  <link rel="stylesheet" href="laptop-style.css">
</head>
<body>
  <div class="container">
    <h2>Laptop Complaint Registration</h2>

    <!-- Technician Availability -->
    <p style="text-align: center; color: green; font-weight: bold;">
      🛠 Available Technicians for Laptop: <?php echo htmlspecialchars($availableTechs); ?>
    </p>
    ...
    <form class="complaint-form" id="complaintForm" action="submit_complaint.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="input-group">
        ...
        <select id="preset" name="complaint_type">
          ...
          <option value="Screen flickering or not working">Screen flickering or not working</option>
          <option value="Keyboard/Touchpad issue">Keyboard/Touchpad issue</option>
          <option value="Wi-Fi not connecting">Wi-Fi not connecting</option>
          <option value="OS crash or boot failure">OS crash or boot failure</option>
